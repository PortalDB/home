This project serves as the home page for our Portal system.

The project was created with [Create React App](https://github.com/facebookincubator/create-react-app). (More on that below).

However, it is intended to be hosted on [Github Pages](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md#github-pages)

Thus, to make changes, you should edit the react app on the develop branch.
You can commit and push your source changes to that branch.

When you are ready for your changes to show up on the github page, run:
npm run deploy

That command publishes the compiled app to the master branch, where github pages picks it up and displays the page!

Some notes on the app (if you are unfamiliar with React or Single Page Apps in general):
index.html and index.js bootstrap everything, loading the App component (App.js).

The App component uses react router to define all of the routes.
The MenuComponent contains links to all of those pages.

Adding a page is a matter of creating a new component, adding a rout to it in App.js, and providing a link
to it somewhere (probably the MenuComponent).
